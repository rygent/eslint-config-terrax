...
const pullRequestBody = [
	...
	'',
	`This pull request bumps eslint-config-terrax from **${previousRelease?.tag_name ?? 'unknown'}** to **${
		packageJson.version
	}**.`,
	'',
...
console.log(`🎉 Creating pull request for eslint-config-terrax ${packageJson.version}`);
