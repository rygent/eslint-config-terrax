...
const IGNORED_COMMIT_AUTHORS = ['dependabot[bot]'];
...
// eslint-disable-next-line no-console
console.info(
	`✅ Done! eslint-config-terrax was bumped to ${newVersion['eslint-config-terrax']}! Checking if there was a pull request open already and closing it if so...`
);
